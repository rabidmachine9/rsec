...
export const Screen: FunctionComponent<ScreenProps> = ({selectedChannel}) => {
    ...
    return (
        <div className="screen">
            ...
            <input type="number" max="100" min="0" id="velocity_range" value={selectedChannel.sequence[state.selectedSeqButton].velocityRange} onChange={handleUpdateVelocityRange}></input><br/>
